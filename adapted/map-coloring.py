# Taken from https://docs.ocean.dwavesys.com/en/stable/examples/map_coloring_full_code.html#map-coloring-full-code
# Had to add a try, except block to make it work
